        ...
        <div class="row justify-content-around mb-0 pt-5 mx-4">
            ...
            <div class="col-xl-2 col-md-3 pt-4 order-1">
                <ul class="list-unstyled">
                    <li class="mt-md-0 mt-4">Notre solution</li>
            ...
            <div class="col-xl-auto col-md-6 col-12 pt-4 my-sm-0 order-6 ">
                <div class="form-group "><label for="email" class="mb-3"><b>Abonnez-vous à notre newsletter.</b></label><input type="email" class="form-control form-control-lg" placeholder="Enter email" id="email"></div><button type="button" class="btn btn-primary btn-lg btn-block my-2 Subscribe mt-4 mb-3">Subscribe</button>
            </div>
        </div>
        <div class="row justify-content-center px-3 py-3 pt-5">
            <div class="col text-center">
                <p class="mb-0">Talent Guinée est une entreprise qui permet à l'Etat Guinéen, aux entreprises ainsi qu'aux institution 
                  internationales
                   </p>
                <p>de recruter Facilement nos talents partout dans le monde.</p>
            </div>
        </div>
    </footer>
</template>
